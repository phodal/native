...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>ios</code></td>
      <td>Complete generated Xcode project around the toolkit UIKit host; archive-ready with zero edits (code signing stays manual)</td>
    </tr>
    <tr>
      <td><code>android</code></td>
      <td>Complete generated host project around the toolkit Android host; the debug APK assembles with zero edits directly with the SDK build tools (store signing stays manual)</td>
    </tr>
  </tbody>
</table>
