...
See the [Quick Start](/quick-start) for the full flow. The package carries prebuilt binaries for macOS (arm64/x64), Linux (gnu/musl, arm64/x64), and Windows (x64); see `packages/native-sdk/` in the repository for the wrapper scripts and packaging metadata.
