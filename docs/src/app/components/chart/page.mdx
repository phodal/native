...
<ComponentPreview name="chart" alt="A chart rendered by the engine" caption="a filled line series and a bar series with gridlines, a baseline, and muted axis tick labels — hover the live preview for per-sample details" />
...
```html
<chart height="160" grid-lines="3" baseline="true" x-labels="{months}" y-labels="true" hover-details="true" label="Build load">
