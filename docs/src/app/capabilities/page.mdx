...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>macOS system-engine host (one player: AVAudioPlayer for local files, AVPlayer for streamed URLs); Linux, Windows, and macOS Chromium report unsupported and playback degrades to one explicit failed Msg</td>
    </tr>
    <tr>
      <td>File drops</td>
