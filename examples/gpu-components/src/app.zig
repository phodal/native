...
pub const GpuComponentsApp = struct {
    ...
    fn event(context: *anyopaque, runtime: *native_sdk.Runtime, event_value: native_sdk.Event) anyerror!void {
        ...
        switch (event_value) {
            ...
            .gpu_surface_resized, .gpu_surface_input, .shortcut, .timer, .effects_wake, .files_dropped, .canvas_widget_scroll, .canvas_widget_file_drop, .canvas_widget_drag, .canvas_widget_context_menu, .canvas_widget_dismiss, .canvas_widget_context_press, .canvas_widget_resize, .window_closed, .automation_provenance, .lifecycle => {},
        }
    }
