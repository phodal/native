...
The Native SDK is a native desktop app framework with selectable web engines, native views, guarded bridge commands, and OS capabilities. Use a WebView for rich product UI, then add native shell surfaces where the operating system should own the interaction.
