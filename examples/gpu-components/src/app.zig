...
pub const GpuComponentsApp = struct {
    ...
    fn event(context: *anyopaque, runtime: *zero_native.Runtime, event_value: zero_native.Event) anyerror!void {
        ...
        switch (event_value) {
            ...
            .gpu_surface_resized, .gpu_surface_input, .shortcut, .timer, .effects_wake, .files_dropped, .canvas_widget_scroll, .canvas_widget_file_drop, .canvas_widget_drag, .lifecycle => {},
        }
    }
